...
# Form implementation generated from reading ui file 'edituserwindow.ui'
#
...
class Ui_EditUserWindow(object):
    def setupUi(self, EditUserWindow):
        ...
        EditUserWindow.resize(516, 328)
        EditUserWindow.setMinimumSize(QtCore.QSize(0, 0))
        EditUserWindow.setMaximumSize(QtCore.QSize(16777215, 16777215))
        self.stylesheet = QtWidgets.QWidget(EditUserWindow)
...
"}\n"
"#topLogo {\n"
"    background-image: url(:/imagem/images/saturn_png.png);\n"
...
"")
        ...
        self.horizontalLayout_12.addWidget(self.btn_saveuser)
        ...
        EditUserWindow.setCentralWidget(self.stylesheet)
    ...
    def retranslateUi(self, EditUserWindow):
        ...
        EditUserWindow.setWindowTitle(_translate("EditUserWindow", "MainWindow"))
        self.titleRightInfo.setText(_translate("EditUserWindow", "Edit User information"))
        self.label.setText(_translate("EditUserWindow", "First name"))
        self.label_2.setText(_translate("EditUserWindow", "Surname"))
        self.label_3.setText(_translate("EditUserWindow", "Organisation"))
        self.label_5.setText(_translate("EditUserWindow", "Phone number"))
        self.label_4.setText(_translate("EditUserWindow", "Email"))
        self.label_6.setText(_translate("EditUserWindow", "Address"))
        self.btn_cancel.setText(_translate("EditUserWindow", "Cancel"))
        self.btn_saveuser.setText(_translate("EditUserWindow", "Save changes to User"))
