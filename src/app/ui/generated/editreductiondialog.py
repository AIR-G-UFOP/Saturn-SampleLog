...
"}")
        ...
        self.startEnd.setFocusPolicy(QtCore.Qt.StrongFocus)
        ...
        self.verticalLayout_18.addWidget(self.generate, 0, QtCore.Qt.AlignLeft)
        ...
        self.btn_saveReduction.setMinimumSize(QtCore.QSize(195, 25))
        ...
        self.btn_saveReduction.setIcon(icon3)
    ...
    def retranslateUi(self, EditeReductionWindow):
        ...
        self.generate.setText(_translate("EditeReductionWindow", "Use file name generator?"))
        self.label_9.setText(_translate("EditeReductionWindow", "File name"))
        self.btn_copy.setText(_translate("EditeReductionWindow", "Copy"))
