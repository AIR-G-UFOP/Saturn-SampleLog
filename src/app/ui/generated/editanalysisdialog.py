...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, -180, 429, 496))
        ...
        self.verticalLayout_14.addWidget(self.generate)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/cil-cancel.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/icons/cill-ok-filled.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.btn_saveAnalysis.setIcon(icon3)
    ...
    def retranslateUi(self, EditAnalysisWindow):
        ...
        self.generate.setText(_translate("EditAnalysisWindow", "Use file name generator?"))
        self.label_6.setText(_translate("EditAnalysisWindow", "File name"))
        self.btn_copy.setText(_translate("EditAnalysisWindow", "Copy"))
